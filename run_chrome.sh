...
DISPLAY=:0 chromium-browser --disable-infobars --kiosk  --password-store=basic --use-pulseaudio --incognito --use-fake-ui-for-media-stream  http://127.0.0.1:8082/index.html
