...
DISPLAY=:0 chromium-browser --disable-infobars --kiosk  --password-store=basic --use-pulseaudio --incognito --use-fake-ui-for-media-stream --remote-debugging-port=9222 http://127.0.0.1:8082/index.html
