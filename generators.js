...
generators={
  ...
  midi_note_on:function(t,args){var v=window.midi.notes[args.channel+" "+args.note]|0; window.midi.notes[args.channel+" "+args.note]=0; return v*args.a+args.o},
  midi_note:function(t,args){var v=window.midi.note[args.channel]|0; return v*args.a+args.o},
  pos:flatten,
  size:flatten,
  rgb:flatten,
  rgba:flatten,
