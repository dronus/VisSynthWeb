...
canvas.reaction2=function(F,K,D_a,D_b,speed) {
    gl.reaction2 = gl.reaction2 || new Shader(null, '\
      ...
      \n\
	      gl_FragColor = vec4(clamp(val + delta * speed,-1.0,1.0), 0.0, 1.0);\n\
      }\n\
    ');

    this._.texture.use(0);
    this.simpleShader( gl.reaction2, {F:F,K:K,D_a:D_a,D_b:D_b,speed:speed , scale: [this.width,this.height] });
