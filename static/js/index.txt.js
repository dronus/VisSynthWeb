const S = [
  ...
  {selector: ".category .env, .theme__env .instruction .cat", lang: "de", text: "Klima und Umwelt"},
  {selector: ".category .kids, .theme__kids .instruction .cat", lang: "de", text: "Kinder und Jugendliche"},
  {selector: ".category .equal, .theme__equal .instruction .cat", lang: "de", text: "Gleichberechtigung"},
  {selector: ".category .aid, .theme__aid .instruction .cat", lang: "de", text: "Nothilfe"},
